...
# Test cases
table1 = [[['Francis', 13], ['Ellis', 11]], [['Andy', 5]], [['Bill', 17],
['Zoe', 14]], [['Coach', 4]], [['Louis', 29], ['Rochelle', 4], ['Nick', 2]]]
hashtable_update(table1, 'Francis', 7)
print(table1)

table2 = [[['search', 'verb']], [], [['Peter', 'proper noun']], [['Udacity',
'super noun']], [['with', 'preposition']]]
hashtable_update(table2, 'Udacity', 'proper noun')
print(table2)

table3 = [[['Francis', 13], ['Ellis', 11]], [['Andy', 5]], [['Bill', 17], ['Zoe', 14]], [['Coach', 4]], [['Louis', 29], ['Rochelle', 4], ['Nick', 2]]]
hashtable_update(table3, 'Luke', 7)
print(table3)
